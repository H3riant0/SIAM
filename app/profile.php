              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Staus :</b> <a class="float-right">Aktif</a>
                  </li>
                  <li class="list-group-item">
                ...
                <a href="#" class="btn btn-primary btn-block"><b>Semester 5</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">KHS</a></li>
